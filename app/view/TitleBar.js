...
export default class TitleBar extends Component {
    ...
    render() {
        ...
        if (select === 0) {
            ...
            image1 =
                <Image style={{width: 60, height: 60}} source={require('../images/actionbar_discover_normal.png')}/>
        }
        return (
                ...
                <View style={{flex: 1, flexDirection: 'row', alignItems: 'center', justifyContent: 'center'}}>
                    ...
                    <TouchableOpacity onPress={() => this.onPress(3)}>
                        <Image style={{width: 60, height: 60}}
                               source={select === 1 ? require('../images/actionbar_music_selected.png') : require('../images/actionbar_music_normal.png')}/>

                    </TouchableOpacity>
                    <TouchableOpacity onPress={() => this.onPress(4)}>
                        <Image style={{width: 60, height: 60}}
                               source={select === 2 ? require('../images/actionbar_friends_selected.png') : require('../images/actionbar_friends_normal.png')}/>
                    </TouchableOpacity>
                </View>
                <View>
